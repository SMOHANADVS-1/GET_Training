 ...
 * 
 * Hibenate Program to save a Product object to the database using XML Configuration.
 */
...
public class ProductApp {
	public static void main(String[] args) {
		...
		//setting values to Product object using setter methods
		p1.setName("Puma Shoes");
		p1.setDescription("Shoes made by Puma");
		p1.setPrice(10000.00f);
		session.save(p1); //object is in persistent state
