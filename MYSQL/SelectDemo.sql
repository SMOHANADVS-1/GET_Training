...
/* Heidi SQL - It's an IDE for working with MariaDB. It's installed automatically.it is a tool to work with databases
...
/* Eg:
 ...
 employees,customers,offices,orderdetails,orders,payments,productlines,products - Tables
*/
...
SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE jobTitle='Sales Rep' AND officeCode=1;
...
SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE jobTitle='Sales Rep' or officeCode=1;
...
SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE officeCode BETWEEN 1 AND 3;
...
SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE lastname LIKE '%son';

SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE lastname LIKE 'b%';
...
SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE lastname LIKE 'b%'OR firstname LIKE 'd%';

SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE firstname LIKE '_arry';

SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE firstname LIKE 'A%';



-- NOT -- Negates the condition
SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE firstname NOT LIKE  'A%';
...
SELECT employeeNumber,firstname, lastname,jobTitle,email, officeCode FROM employees WHERE -- officeCode=1 or officeCode=5 or officeCode=7;
...
SELECT employeeNumber,firstname, lastname,jobTitle,email, reportsTo  FROM employees WHERE reportsTo IS NULL;

select * FROM orders WHERE comments IS NULL;

SELECT * FROM orders WHERE comments IS NOT NULL;

SELECT * FROM orders WHERE comments="";  -- NOT consisdered AS null

SELECT * FROM customers WHERE phone=0;	  -- NOT consisdered AS null
...
SELECT e.firstName,e.lastName FROM employees e orderby e.firstName;
#----------------------------------------------------------------------------
...
SELECT STATUS, COUNT(*) AS Total FROM orders GROUP BY STATUS; -- important
...
SELECT jobTitle,COUNT(jobTitle) FROM employees GROUP BY jobTitle; -- or SELECT jobTitle,COUNT(*) as 'count of jobtitle'  FROM employees GROUP BY jobTitle;
...
SELECT UPPER(customerName) CustomerName,MID(city,1,3) ShortCity,city FROM customers;
