...
DESCRIBE USER; -- displays the structure OF table
...
INSERT INTO staff(NAME,email) VALUES('Mohana', 'mohana123@training.com');	

INSERT INTO staff(NAME,email) VALUES('Mike', 'mike@training.com');	

INSERT INTO staff(NAME,email) VALUES('nikitha', 'nikki@training.com');	

SELECT * FROM staff;

-- insert data into default columns
INSERT INTO staff(NAME,email,city) VALUES('Mohana', 'mohana123@training.com','Guntur');	

INSERT INTO staff(NAME,email,city) VALUES('Mike', 'mike@training.com','delhi');	

INSERT INTO staff(NAME,email,city) VALUES('nikitha', 'nikki@training.com','vijayawada');	

INSERT INTO staff(NAME,email,city) VALUES('Monna', 'mohnna123@training.com','Guntur');	

INSERT INTO staff(NAME,email,city) VALUES('Mitu', 'mitu@training.com','delhi');	

INSERT INTO staff(NAME,email,city) VALUES('nikil', 'nikkil@training.com','vijayawada');	
...
INSERT INTO staff(NAME,email,city,doj)
	VALUES('Mahesh','mahesh@training.com','chennai',current_date);
...
INSERT INTO staff VALUES
	(200,'Raj','raj@test.com','Delhi','2018-12-07','Mal',10000,99999);
	
-- throw check constraint error for salary
INSERT INTO staff VALUES
	(202,'keerti','keerti@test.com','ranchi','2018-1-07','Female',9000,787878);

SELECT * FROM staff;

-- throw PRIMARY KEY constraint error for ID
INSERT INTO staff VALUES
	(202,'Raj','raj@test.com','Delhi','2018-12-07','Male',15000,989898);
...
-- throw check constraint error for salary
INSERT INTO staff VALUES
	(204,'Monty','monty@test.com','Chennai','2018-02-07','Male',9000,989898);

INSERT INTO staff VALUES
	(20,'Monty','monty@test.com','Chennai','2018-02-07','Male',15000,989898);
...
INSERT INTO staff VALUES
	(204,'Monty','monty@test.com','Chennai','2018-02-07','Male',15000,989898);
...
-- not null constraint 
INSERT INTO staff VALUES
	(110,'Navin','navin@test.com','blr','2018-12-07','Male',NULL,8686831);
...
-- INSERT INTO employees VALUES(1002,'Mary','John','2012-12-12',2,'Electrician',CURRENT_DATE,103);
...
INSERT INTO employees1 VALUES(1002,'Mai','nikil','2012-5-12',2,'Electrician',
				CURRENT_DATE, 102);

INSERT INTO employees1 VALUES(1003,'Joy','John','2012-2-19',2,'Electrician',
				CURRENT_DATE, 103);
...
DELETE FROM departments1 WHERE d_id = 103; -- deletes becoz of cascade

UPDATE departments1 SET dept_name= 'Computer Science' WHERE d_id = 101;
